  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Belohnungen verwalten</h1>
        <p className="text-gray-600">Wählen Sie einen Kurs aus, um Belohnungen zu verwalten</p>
      </div>
